...
let lastCar = Object.values(inventory)[inventory.length - 1];
console.log(lastCar);
...
console.log("Sorted car models:" + carModels.sort());
...
console.log("List of car's years:" + carYears);
...
console.log("We have " + oldCars.length + " old cars!"); 
